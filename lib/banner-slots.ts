...
export const BANNER_SLOT_DEFINITIONS: BannerSlotDefinition[] = [
  ...
  { key: "category-cultura", label: "Categoría - cultura", location: "Categorías", device: "responsive" },
  ...
  { key: "post-cultura", label: "Posts - cultura", location: "Detalle de post", device: "responsive" },
